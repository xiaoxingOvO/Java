...
public class ProxyTest {
    public static void main(String[] args) {
        ...
        Human propertyInstance = (Human) ProxyFactory.getProxyInstance(superMan);
        //当通过代理类对象调用方法时，会自动的调用被代理类中同名的方法
        String belidf = propertyInstance.getBelidf();
        System.out.println(belidf);
        propertyInstance.eat("四川麻辣烫");
