...
public class MapTest {
 ...
 Set entrySet()：返回所有key-value对构成的Set集合
    ...
    public void test5(){
        ...
        System.out.println();
        //遍历所有的key-value
        System.out.println("遍历所有的key-value,方式一");
        //方式一：entrySet()
        ...
        System.out.println();
        //方式二：
        System.out.println("遍历所有的key-value,方式二");
 ...
 void clear()：清空当前map中的所有数据
    ...
    public void test3(){
        ...
        map.put(45,123);
        map.put("BB",56);
        System.out.println("添加后：map = " + map);
        //修改
        map.put("AA",87);
        ...
        System.out.println("添加所有：map1 = " + map);

        //remove(Object key)
        Object value = map.remove("CC");
        System.out.println("返回删除键的value: = " + value);
